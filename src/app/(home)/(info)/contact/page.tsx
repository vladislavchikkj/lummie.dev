...
export default function ContactPage() {
	return (
		// Используем bg-background и text-foreground для поддержки тем
		<div className='bg-background text-foreground antialiased'>
			<div className='container mx-auto max-w-7xl px-4 py-20 sm:py-28 lg:py-36'>
				{/* --- Hero Section --- */}
				<header className='text-center max-w-3xl mx-auto'>
					{/* Убираем градиент для лучшей читаемости в светлой теме */}
					<h1 className='text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-foreground'>
						Get in Touch
					</h1>
					{/* Используем text-muted-foreground для второстепенного текста */}
							...
							<div className='p-10 md:p-12 border-b md:border-b-0 md:border-r'>
								...
								<div className='mt-10 space-y-8'>
									<div className='flex items-start gap-4'>
										{/* Используем bg-muted для фона иконок */}
