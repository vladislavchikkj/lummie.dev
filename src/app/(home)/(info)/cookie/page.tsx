...
export const metadata: Metadata = {
  ...
  openGraph: createOpenGraphMetadata(PAGE_SEO.cookie.title),
  twitter: createTwitterMetadata(PAGE_SEO.cookie.title),
}
      ...
      <div className="container mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        ...
        <main className="mt-12 space-y-6 rounded-xl bg-white p-8 text-lg leading-relaxed shadow-2xl shadow-indigo-100/50 dark:bg-zinc-800 dark:shadow-none">
          ...
          <p>
            ...
            cookies are required for technical reasons for our Services to
            ...
            of our users to enhance the experience on our Services. Third
            parties serve cookies through our Services for advertising,
          ...
          <p>
            ...
            such as accessing secure areas and maintaining your session. We are
            not required to obtain your consent for these cookies.
          </p>
          ...
          <p>
            ...
            of our Services but are non-essential to their use. However, without
            these cookies, certain functionality (like remembering preferences)
          ...
          <ul className="ml-6 list-disc space-y-2">
            <li>
              ...
              Remembering your login details, site preferences, and regional
              settings.
            </li>
          </ul>
          ...
          <ul className="ml-6 list-disc space-y-2">
            <li>
              ...
              Tracking site traffic, analyzing user behaviour (e.g., using
              Google Analytics), and improving the user interface.
            </li>
          </ul>
          ...
          <ul className="ml-6 list-disc space-y-2">
            <li>
              ...
              Delivering targeted advertisements, measuring the effectiveness of
              ad campaigns, and providing data to advertising partners.
            </li>
          </ul>
          ...
          <p>
            ...
            appropriate opt-out links provided within the cookie banner on our
            website or by managing your preferences through your browser
            settings.
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li>
            ...
            <li>
              ...
              For users in regions requiring explicit consent (like the European
              Union), we will deploy a cookie consent mechanism that allows you
              to manage which non-essential cookies are enabled.
            </li>
          </ul>
